...
def classPhotos(redShirtHeights, blueShirtHeights):
    ...
    for i, red in enumerate(redShirtHeights):
        if first_row_color == "red" and redShirtHeights[i] >= blueShirtHeights[i]:
            return False
        elif first_row_color == "blue" and redShirtHeights[i] <= blueShirtHeights[i]:
            return False
